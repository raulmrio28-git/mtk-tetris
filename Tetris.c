...
*
*  THE TRANSACTION CONTETRISD HEREUNDER SHALL BE CONSTRUED IN ACCORDANCE
 ...
 *    TETRIS with XXXXXX (XXXX is the game name in caption)           
 *    Tetris with Xxxxxx                                        
 *    tetris with xxxxxx                                           
 *                                                                
 ...
 *******************************************************************************/
#ifndef _MMI_GX_TETRIS_C
#define _MMI_GX_TETRIS_C
...
void mmi_gx_tetris_enter_gfx(void)
{
    ...
    /*----------------------------------------------------------------*/
    /* Game menu */
    GFX.game_data.game_img_id = IMG_ID_GX_TETRIS_GAME_ICON;   /* game icon img ID */
    GFX.game_data.game_str_id = STR_ID_GX_TETRIS_GAME_NAME;   /* game name string ID */
    GFX.game_data.menu_resume_str_id = STR_ID_GX_TETRIS_RESUME;       /* "Resume" string ID */
    GFX.game_data.menu_new_str_id = STR_ID_GX_TETRIS_NEW; /* "New Game" string ID */
    GFX.game_data.menu_level_str_id = STR_ID_GX_TETRIS_LEVEL; /* "Game Level" string ID */
    GFX.game_data.menu_grade_str_id = STR_ID_GX_TETRIS_SCORE; /* "Best Grade" string ID */
    GFX.game_data.menu_help_str_id = STR_ID_GX_TETRIS_HELP;   /* "Game Help" string ID */

    /* level / grade */
    GFX.game_data.level_count = 3;  /* how many levels */
    GFX.game_data.level_str_id_list[0] = STR_ID_GX_TETRIS_LEVEL_EASY; /* level string ID */
    GFX.game_data.level_str_id_list[1] = STR_ID_GX_TETRIS_LEVEL_NORMAL;       /* level string ID */
    GFX.game_data.level_str_id_list[2] = STR_ID_GX_TETRIS_LEVEL_HARD; /* level string ID */
    ...
    /* help */
    GFX.game_data.help_str_id = STR_ID_GX_TETRIS_HELP_DESCRIPTION;    /* help desciption string id */

    /* misc */
    GFX.game_data.grade_value_ptr = (S16*) (&g_gx_tetris_context.game_grade);        /* current level's grade (S16*) */
    GFX.game_data.level_index_ptr = (U8*) (&g_gx_tetris_context.game_level); /* ptr to current level index (U8*) */
    ...
    GFX.game_data.draw_gameover_func_ptr = mmi_gx_tetris_draw_gameover;       /* function to draw gameover screen */
...
void mmi_gx_tetris_exit_game(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_cancel_timer(mmi_gx_tetris_cyclic_timer); /* cancle the looping timer */
}
